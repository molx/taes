...
$(document).ready(function() {
    ...
    function equalizeTabHeights(selector) {
        let maxHeight = 0;
    ...
    equalizeTabHeights('.tab-content1');
    equalizeTabHeights('.tab-content2');
    equalizeTabHeights('.tab-content3');
    equalizeTabHeights('.tab-content4');
